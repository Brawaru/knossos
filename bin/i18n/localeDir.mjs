...
export class LocaleDirectory {
   ...
   *
   * @returns {Promise<
   *   | (ReturnType<typeof readMetaFile> extends Promise<infer R> ? R : never)
   *   | undefined
   * >}
   *   Meta file object used to access various meta properties of the locale.
   * @throws If no meta file exists for the directory or directory was not yet
   *   scanned to find one.
   */
  async parseMetaFile() {
    if (this._metaFile == null) return undefined
